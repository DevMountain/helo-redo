...
10) Copy the connection string from your `.env` file into `SQLTabs` and create the users table and the posts table  (make sure you put `?ssl=true` on the end of the string when using SQLTabs).
